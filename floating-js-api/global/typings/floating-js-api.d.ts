...
declare module 'unblu-floating-js-api' {
    ...
    import { CallStateListener, ConnectionStateListener, Conversation, ConversationStateListener, CustomActionInvocationListener, InvitationsListener } from 'unblu-floating-js-api/shared/conversation';
    ...
    export interface Unblu {
            /**
                ...
                *
                * **Note:** This field and its {@link api} field will be available as soon as the Unblu Floating API has been loaded, no matter if loaded as script import or as ES-Module.
